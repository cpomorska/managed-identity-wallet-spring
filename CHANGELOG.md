...
* **ci:** install Taskfile ([a30492e](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a30492e79fc73092ac678180e80cc08837d84676))
...
* dockerfile ([234a7a0](https://github.com/cpomorska/managed-identity-wallet-spring/commit/234a7a05d6839409b1a62a1d15ac3a424cfad20c))
...
* **helm:** add random generated encryption_key ([495f2d9](https://github.com/cpomorska/managed-identity-wallet-spring/commit/495f2d907fdfdc66d125a083070243b83964c75b))
...
* javadoc, imports and throws ([af87ecb](https://github.com/cpomorska/managed-identity-wallet-spring/commit/af87ecb3a79fa49577af0aa0da31d22366e48791))
...
* sonar issues ([a7fb417](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a7fb417e694c6199618e1e51e62c53b33c173089))
...
* wrong helm docs version in ci PR [#219](https://github.com/cpomorska/managed-identity-wallet-spring/issues/219) ([3f1ed66](https://github.com/cpomorska/managed-identity-wallet-spring/commit/3f1ed6628854900a28ab87d54582a037986ed5c2))
...
* add logic regarding jti info store and check ([6809578](https://github.com/cpomorska/managed-identity-wallet-spring/commit/6809578d208bc0380fa8a34bf119227e12ea1ecd))
...
* adjust task 'stopDockerApp' to stop the actual container 'local_miw_app' ([e686b3e](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e686b3e50676d9a9bb47b7ed873ee740e1ba7b91))
...
* **ci:** add --wait to helm install ([b4a56b0](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b4a56b028778fc5147cc7492ba3de1b313bf7ba2))
...
* credentials validation api wip ([43454f9](https://github.com/cpomorska/managed-identity-wallet-spring/commit/43454f9453a1f0e04360f0b60a7ffd4e0ca68d1c))
...
* **devel:** include checks and new "local.env" + add check-prerequisites task ([99ac665](https://github.com/cpomorska/managed-identity-wallet-spring/commit/99ac665be0742f1de261f67d46ab2e7b2b81c3fa))
...
* **devel:** WIP: add more stuff to Taskfile ([ed2277f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/ed2277f9dbf690fea1815e5f82832b4909727922))
...
* **helm:** add documentation for new content and adjust the old one ([6689718](https://github.com/cpomorska/managed-identity-wallet-spring/commit/66897186da42ef7dfb9af08d549682964aa5472c))
...
* **helm:** configure MIW Helm chart to use pgadmin4 subchart PR [#209](https://github.com/cpomorska/managed-identity-wallet-spring/issues/209) ([8d18845](https://github.com/cpomorska/managed-identity-wallet-spring/commit/8d18845ef841b791c13597af0398ee10b752b7e9))
...
* Holder identifier added in framework VC subject ([e65af19](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e65af19f777154e7f2bc69f90e40e32feef52dbf))
...
* **persistence:** adjust naming to snake_case and add suffixes ([720217f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/720217fdfa650e2785a92708df688d8738bf04bc))
...
* **readme:** adds overview of the required roles per endpoint ([391a7a7](https://github.com/cpomorska/managed-identity-wallet-spring/commit/391a7a7f4d4242a6390a8a13fa1a8329bb9a7d4e))
* reamdme added with env verables, vp as jwt, credentials id added in table, search with credential id ([524c537](https://github.com/cpomorska/managed-identity-wallet-spring/commit/524c5370aabd95e95b9c23eb902543394a0dbbb2))
* reamdme added with env verables, vp as jwt, credentials id added in table, search with credential id ([e654a57](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e654a5744438cb32aac96ef405cb7f97a48554ba))
* release workflow added for revocation-service ([f70b345](https://github.com/cpomorska/managed-identity-wallet-spring/commit/f70b3451c357dacd9b63e324efd23018723547f5))
* remove BaseController, change Principal to Authenticationand unit test cases added ([15425be](https://github.com/cpomorska/managed-identity-wallet-spring/commit/15425beccd8bbb3560328d7d845766f422e6e4d8))
* remove commit link from changelog template ([bf8106e](https://github.com/cpomorska/managed-identity-wallet-spring/commit/bf8106e8903b239a804577b5c10d25586ae494ea))
* removed endpoint from config file ([93612f7](https://github.com/cpomorska/managed-identity-wallet-spring/commit/93612f791be46d2bb7de2022c47454495a986b9c))
* removed endpoint from config file ([b3e9f5f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b3e9f5f8724721f43540aef0e788725089c13a74))
* rename tasks from beginning with 'run' to beginning with 'start' to achieve a uniform 'start...' and 'stop...' appearance of task names. ([a3f3f1c](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a3f3f1c4f9450cc436537672dc439a5e598ea0b5))
* rename tasks from beginning with 'run' to beginning with 'start' to achieve a uniform 'start...' and 'stop...' appearance of task names. ([7d59df4](https://github.com/cpomorska/managed-identity-wallet-spring/commit/7d59df41b902e4cdf16b2ab08fbf15a91c83e3a2))
* Resolve the DID document for a given DID or BPN api added ([1368edf](https://github.com/cpomorska/managed-identity-wallet-spring/commit/1368edfb1cef1cac0640b599bd8ba76b7e2aa627))
* Resolve the DID document for a given DID or BPN api added ([b5407e6](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b5407e6f0068895a69986a6423aeedc9ed5f6af4))
* revert renaming and postpone that for later. ([3a63399](https://github.com/cpomorska/managed-identity-wallet-spring/commit/3a63399e80220bca2de0ed3bdcaf3b453b68c8fa))
* revert renaming and postpone that for later. ([3a9a209](https://github.com/cpomorska/managed-identity-wallet-spring/commit/3a9a209a6417e1eb7760c9f041b1952934d696e4))
* revoke API, revocation support in issue VC API, wallet-commons module for common classes ([ec8bb00](https://github.com/cpomorska/managed-identity-wallet-spring/commit/ec8bb008746ee901acccc8eaccda3e5793aea775))
* run Docker release on PR only on specific folders ([186104d](https://github.com/cpomorska/managed-identity-wallet-spring/commit/186104d46dbe3e84813e790e546214da2c6e5008))
* save dash.jar in the root project for easy re-use ([98747c8](https://github.com/cpomorska/managed-identity-wallet-spring/commit/98747c8357e769259c9ef44b80fe5c469a0d82d0))
* set health check actuator resp. liveliness probe endpoint to '/actuator/health/liveness' and readiness probe endpoint to '/actuator/health/readiness' both on port '8090' ([af44016](https://github.com/cpomorska/managed-identity-wallet-spring/commit/af44016dc3e04d5e7e1448007cb73a429c529de9))
* set health check actuator resp. liveliness probe endpoint to '/actuator/health/liveness' and readiness probe endpoint to '/actuator/health/readiness' both on port '8090' ([24c88be](https://github.com/cpomorska/managed-identity-wallet-spring/commit/24c88be0d644666951f928493a4df1b2aaebfffb))
* Spring security added with keycloak, Swagger added, Testcases modification based on spring security ([aed48ee](https://github.com/cpomorska/managed-identity-wallet-spring/commit/aed48ee4de89ab0df1d649260609db69264b6530))
* Spring security added with keycloak, Swagger added, Testcases modification based on spring security ([2345a33](https://github.com/cpomorska/managed-identity-wallet-spring/commit/2345a332e58262c3e49aba2cb9e7e3c2d97d1802))
* ssi lib v4 added, autority wallet config added ([1c5ee0e](https://github.com/cpomorska/managed-identity-wallet-spring/commit/1c5ee0e116bbc0ad69525da8cc7a3fbdfa67da4a))
* ssi lib v4 added, autority wallet config added ([57c8803](https://github.com/cpomorska/managed-identity-wallet-spring/commit/57c88033d6af4476ef951466f955777bdc4c6f9b))
* ssi-lib version set to 15 ([910aa2a](https://github.com/cpomorska/managed-identity-wallet-spring/commit/910aa2af97dc833da0b9b52fe463b1ca59e1afc3))
* ssi:lib version updated ([4939ddb](https://github.com/cpomorska/managed-identity-wallet-spring/commit/4939ddb2d9d4f4b982ffeb75279414b63d16a005))
* ssi:lib version updated ([404b65b](https://github.com/cpomorska/managed-identity-wallet-spring/commit/404b65bd325c09959cf79788972aebae6926347b))
* status list VC type set to StatusList2021 ([4429211](https://github.com/cpomorska/managed-identity-wallet-spring/commit/4429211d8b3bcb999b35a268f4fe588b9b28ef20))
* Store credential API with test case, Validate test case ([4911817](https://github.com/cpomorska/managed-identity-wallet-spring/commit/4911817dfdf40038cc2298d62676d4e2fa25c2b2))
* Store credential API with test case, Validate test case ([99307bf](https://github.com/cpomorska/managed-identity-wallet-spring/commit/99307bfb94b5f9294e9edce8b8f4b2522273ff08))
* Store credntial API, testcase mofitication based on DidDocument Java POJO ([569097b](https://github.com/cpomorska/managed-identity-wallet-spring/commit/569097b392d0fb7242ed9df47fcaf5fda40904b0))
* Store credntial API, testcase mofitication based on DidDocument Java POJO ([a0ca176](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a0ca176a7e8b59da9120d2756f49ddb6ff0b7831))
* summary credential test cases added ([b322515](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b322515b8b5ed1f9fa10f7cd0138820ba15a7e6e))
* summary credential test cases added ([0340efb](https://github.com/cpomorska/managed-identity-wallet-spring/commit/0340efb5496f6e83949a3094aade7b8f6b6f1bc2))
* summary VC context URL updated ([0cc6bfb](https://github.com/cpomorska/managed-identity-wallet-spring/commit/0cc6bfbd61d845689d6b0fe56214fd03b98bf0e6))
* summary VC context URL updated ([5a52c43](https://github.com/cpomorska/managed-identity-wallet-spring/commit/5a52c431684338fe9b69f543ee0425974726ce62))
* Summary VC flow, code changes as per input given in code review, test case changes as per summary VC flow ([07c4706](https://github.com/cpomorska/managed-identity-wallet-spring/commit/07c4706a8beb85313f325317e5feb9dca6bfff17))
* Summary VC flow, code changes as per input given in code review, test case changes as per summary VC flow ([50b6168](https://github.com/cpomorska/managed-identity-wallet-spring/commit/50b6168fedccd15076044a8a2aa03b3cdbd6d34f))
* summery VC flow after holder delete summary VC ([1b61f38](https://github.com/cpomorska/managed-identity-wallet-spring/commit/1b61f38c721ef961e4f6d5c97555a3dc49c1668d))
* summery VC flow after holder delete summary VC ([33135c1](https://github.com/cpomorska/managed-identity-wallet-spring/commit/33135c18b5de0734b26e9c0cb536860811299b13))
* support new algorithm (WIP) ([9dd6f27](https://github.com/cpomorska/managed-identity-wallet-spring/commit/9dd6f27f33311fc4e4467a412a4ee77eff617e18))
* swagger doc request example updated ([550cabb](https://github.com/cpomorska/managed-identity-wallet-spring/commit/550cabb1b945861e2e0a88f9e1688c6e9293ffe6))
* swagger doc updated as per new role in api and Retrieve wallet by identifier test cases updated ([330d207](https://github.com/cpomorska/managed-identity-wallet-spring/commit/330d207e239004340465ecfb34c606a658616c26))
* test case added for VC expiry check while VP validate as JWT ([e605d60](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e605d608d9997796031f9831844bf8faec7616b9))
* test case of validate vc wip ([2123468](https://github.com/cpomorska/managed-identity-wallet-spring/commit/21234689065a7a39fc45a6d87ce40e7dc79e3ff2))
* test case of validate vc wip ([e4c2ff0](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e4c2ff06c50ac7b348ec31231e02037fa2f2b110))
* test cases added for issueMembershipCredential api ([a3d19c1](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a3d19c15ad59c57cd06f18fa5630e9555d639d10))
* test cases added for issueMembershipCredential api ([1666bcc](https://github.com/cpomorska/managed-identity-wallet-spring/commit/1666bccbfacef2ad423b00e4bc7d688f24bc994f))
* test cases added, file header updated and detail log added for security events ([a4fa6cc](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a4fa6cc37d72e57796616fd87716fef059770e76))
* test coverage verification added at root gradle level and javadoc for miw-commons ([6a7cff2](https://github.com/cpomorska/managed-identity-wallet-spring/commit/6a7cff2acb846fa9b664b359ec8fc179673df459))
* **test:** add Helm unittests for default values ([cc6d2bf](https://github.com/cpomorska/managed-identity-wallet-spring/commit/cc6d2bf32f711dd0b745e9e24c7bc73cb02cb5b3))
* **test:** add Helm unittests for default values ([c0f26e4](https://github.com/cpomorska/managed-identity-wallet-spring/commit/c0f26e4b47b36e300930b3178b4a5606a26a39c1))
* Testcase modification as per new API specification ([f29edb3](https://github.com/cpomorska/managed-identity-wallet-spring/commit/f29edb30ff9c651be10dc082ef6454fd293e7177))
* Testcase modification as per new API specification ([3990eee](https://github.com/cpomorska/managed-identity-wallet-spring/commit/3990eee105de860395011fc3a4e0cd7d490d7906))
* token support added in swagger ([cd74001](https://github.com/cpomorska/managed-identity-wallet-spring/commit/cd74001c323a54c4dcc9094daca42614c5826ff6))
* token support added in swagger ([813ce33](https://github.com/cpomorska/managed-identity-wallet-spring/commit/813ce3305035f66c34d4e696e1ed5819623d4c1f))
* Uncomment KC_HOSTNAME in env.docker.dist and env.local.dist (is required, not optional) ([aaeefc6](https://github.com/cpomorska/managed-identity-wallet-spring/commit/aaeefc61546d4ed3fa6fe0c91527e73d17068f45))
* update ditignore and dev.env added ([b90fe94](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b90fe944a6f447e54349ff1ef99298d7fa9f2468))
* update ditignore and dev.env added ([6ff0555](https://github.com/cpomorska/managed-identity-wallet-spring/commit/6ff0555f77492f2420fca9ba18fa0087c700d5c8))
* update lib method to resolved vc/vp validate ([6f70b09](https://github.com/cpomorska/managed-identity-wallet-spring/commit/6f70b09523bed428472ed61c0c88964473a243b5))
* update lib method to resolved vc/vp validate ([1556d7c](https://github.com/cpomorska/managed-identity-wallet-spring/commit/1556d7c9e6b9f9449625f56503a9eb80b064a827))
* updated context url of did document and test case ([0b05e15](https://github.com/cpomorska/managed-identity-wallet-spring/commit/0b05e15bfd9e366d80c9004f0b3e9b5aea255438))
* updated create wallet api ([ba320ab](https://github.com/cpomorska/managed-identity-wallet-spring/commit/ba320ab31fbed0c833ffb8462b0b39c4a5ab3648))
* updated create wallet api ([c5ad2a1](https://github.com/cpomorska/managed-identity-wallet-spring/commit/c5ad2a12e0a44c1f7202d67044233264e546d427))
* updated credential get api ([1698996](https://github.com/cpomorska/managed-identity-wallet-spring/commit/16989967d67160ffbff6a0b9eae4d616634fd456))
* updated credential get api ([c6e2af4](https://github.com/cpomorska/managed-identity-wallet-spring/commit/c6e2af47a0e7b2fc6a0df4b9a68bb2c6dbaa512e))
* updated issuer credential api and test cases as per new api spec ([f33b056](https://github.com/cpomorska/managed-identity-wallet-spring/commit/f33b056c41584e65492b028cebb7f4a9f361d01d))
* updated issuer credential api and test cases as per new api spec ([921becf](https://github.com/cpomorska/managed-identity-wallet-spring/commit/921becf0d35597e4209cf6e2dc9e689c0ab2b8b0))
* updated issuer credential api and test cases as per new api spec ([c0f493b](https://github.com/cpomorska/managed-identity-wallet-spring/commit/c0f493b779175836ba98b774a7d025a0a3b96809))
* updated issuer credential api and test cases as per new api spec ([ff20227](https://github.com/cpomorska/managed-identity-wallet-spring/commit/ff2022747151fd887fcc712cfa3995d978b83fbc))
* updated store credential api ([74df138](https://github.com/cpomorska/managed-identity-wallet-spring/commit/74df138aa01417887e2bd439178f1e80b7be840a))
* updated store credential api ([f1e5289](https://github.com/cpomorska/managed-identity-wallet-spring/commit/f1e5289abe321a7c1153bbbb831035821bf2f1a4))
* updated swagger doc ([e6179d1](https://github.com/cpomorska/managed-identity-wallet-spring/commit/e6179d170da340dc7c1d192c516b28778e15fd30))
* updated swagger doc response sample and env file ([cba1d5f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/cba1d5fff6dacc7cd09ec89f072bfc1fc9e083fd))
* updated vc type ([8b6ebfa](https://github.com/cpomorska/managed-identity-wallet-spring/commit/8b6ebfadbddabe9342b227e8043be110f7ae1ae1))
* updated vc type ([5acbea5](https://github.com/cpomorska/managed-identity-wallet-spring/commit/5acbea5c499a32a062819ec2987171efdff1391b))
* upload helm chart asset to GitHub release ([f7a1043](https://github.com/cpomorska/managed-identity-wallet-spring/commit/f7a1043d47b9da19c8030b3e5c16fcb8ee79eccd))
* upload miw jar to gh release ([a7d6aa6](https://github.com/cpomorska/managed-identity-wallet-spring/commit/a7d6aa66b3468e4975711c72f1cfdbf3055dcd20))
* use a spring validator for SecureTokenRequest ([accc0d2](https://github.com/cpomorska/managed-identity-wallet-spring/commit/accc0d20404852035876cb7cb4ce5ce7b5da6e64))
* validate issuer bpn while creating new wallet ([99b0117](https://github.com/cpomorska/managed-identity-wallet-spring/commit/99b0117c2c2ce71d6f69b22d528e41c2656feba4))
* validate VP and validate VC test cases updated with mock ([7531191](https://github.com/cpomorska/managed-identity-wallet-spring/commit/7531191afc62fba81d16aeef26b2ff0a84f20fd8))
* validate VP and validate VC test cases updated with mock ([26a91da](https://github.com/cpomorska/managed-identity-wallet-spring/commit/26a91da5234ac789515be501f5b6120e80e389c3))
* validate VP as jwt API, enforce https while did resolve in config, changes according to new lib ([235420f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/235420fcd3eed36e575c10951bb067b0bb530e9a))
* validate VP as jwt API, enforce https while did resolve in config, changes according to new lib ([0339069](https://github.com/cpomorska/managed-identity-wallet-spring/commit/0339069c4c90baf4a27829e2fa56c809f76659e5))
* validation added in issue VC api for summary VC ([97ac189](https://github.com/cpomorska/managed-identity-wallet-spring/commit/97ac189d1e2ef13da12432c2e340d5b9140fa8cf))
* validation added in issue VC api for summary VC ([159637a](https://github.com/cpomorska/managed-identity-wallet-spring/commit/159637a3ce5787c4470b36275b14710aa79022a2))


### Reverts

* Revert "delete file" ([963d008](https://github.com/cpomorska/managed-identity-wallet-spring/commit/963d008feaaf7e3bbb98fbceb9d6debec353f345))
* Revert "enabling sqlite usage within scheduler" ([b33936f](https://github.com/cpomorska/managed-identity-wallet-spring/commit/b33936f33d712aebd8c85068e72ef58a66dbb819))
* Revert "Release MIW 0.3.0 ([#190](https://github.com/cpomorska/managed-identity-wallet-spring/issues/190))" ([#193](https://github.com/cpomorska/managed-identity-wallet-spring/issues/193)) ([28978a8](https://github.com/cpomorska/managed-identity-wallet-spring/commit/28978a8139b0bebe064224bfc29fccea795613af))
